...
#     # Condiciones Iniciales (en unidades SI)
#     P0_Pa = P0 * 1000 # Convertir P0 de kPa a Pa
...
# def busqueda_presion_inversa(v_deseada, P_min_kPa, P_max_kPa, tolerancia_v=0.1):
#     """
...
# P0_calculada = busqueda_presion_inversa(v_objetivo, P_min_kPa, P_max_kPa)
...
#     print(f"Presión Inicial Requerida (P0): {P0_calculada:.2f} kPa")
