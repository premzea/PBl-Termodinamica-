...
#     https://colab.research.google.com/drive/1ycoHw6WyVMEYiVEWfWi5dILrtmEI9Mld
# """
...
# The function
def velocity(h, D, kmu, dragCoefficients: list[float], g, vs: list[float], m):
  vo = 20 #m/s
...
# def Qcalc(P, Pb, r_max, Cv, T, Gg, Z, B):
...
# def sistema_rohrbach(t, y, V0, d, A, T, r_max, Cv, Gg, Z, B, P_atm, f, m, R, b, a):
# # """
...
# def simulacion_rohrbach(P0, V0, d, L, A, T, P_atm, r_max, Cv, Gg, Z, B, f, m, b, R, a):
# # """
...
#         y0,
#         args=(V0, d, A, T, r_max, Cv, Gg, Z, B, P_atm, f, m, R, b, a),
#         method='RK45',
...
#   d = 0.1           # nuestro(m) (corre)

#   # Parámetros Empíricos de la Válvula Calibrada -> Me gustaria revisarlos
